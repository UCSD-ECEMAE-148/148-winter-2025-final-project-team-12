  ...
  void * untyped_ros_message)
{
  ...
  // Field name: calib_t_tag
  {
    ...
    if (!rosidl_runtime_c__uint32__Sequence__init(&ros_message->calib_t_tag, size)) {
      return "failed to create array for field 'calib_t_tag'";
    }
    auto array_ptr = ros_message->calib_t_tag.data;
    cdr.deserializeArray(array_ptr, size);
  }
...
static size_t _EsfMEAS__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_ublox_msgs__msg__EsfMEAS(
    full_bounded, 0);
}
