...
{
  ublox_msgs__msg__RxmSVSISV * msg = (ublox_msgs__msg__RxmSVSISV *)malloc(sizeof(ublox_msgs__msg__RxmSVSISV));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__RxmSVSISV__Sequence__init(ublox_msgs__msg__RxmSVSISV__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__RxmSVSISV *)calloc(size, sizeof(ublox_msgs__msg__RxmSVSISV));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__RxmSVSISV__Sequence * array = (ublox_msgs__msg__RxmSVSISV__Sequence *)malloc(sizeof(ublox_msgs__msg__RxmSVSISV__Sequence));
  if (!array) {
    return NULL;
  }
