...
{
  ublox_msgs__msg__MonGNSS * msg = (ublox_msgs__msg__MonGNSS *)malloc(sizeof(ublox_msgs__msg__MonGNSS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__MonGNSS__Sequence__init(ublox_msgs__msg__MonGNSS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__MonGNSS *)calloc(size, sizeof(ublox_msgs__msg__MonGNSS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__MonGNSS__Sequence * array = (ublox_msgs__msg__MonGNSS__Sequence *)malloc(sizeof(ublox_msgs__msg__MonGNSS__Sequence));
  if (!array) {
    return NULL;
  }
