...
{
  ublox_msgs__msg__RxmRTCM * msg = (ublox_msgs__msg__RxmRTCM *)malloc(sizeof(ublox_msgs__msg__RxmRTCM));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__RxmRTCM__Sequence__init(ublox_msgs__msg__RxmRTCM__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__RxmRTCM *)calloc(size, sizeof(ublox_msgs__msg__RxmRTCM));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__RxmRTCM__Sequence * array = (ublox_msgs__msg__RxmRTCM__Sequence *)malloc(sizeof(ublox_msgs__msg__RxmRTCM__Sequence));
  if (!array) {
    return NULL;
  }
