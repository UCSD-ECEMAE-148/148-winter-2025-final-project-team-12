...
{
  ublox_msgs__msg__CfgGNSS * msg = (ublox_msgs__msg__CfgGNSS *)malloc(sizeof(ublox_msgs__msg__CfgGNSS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgGNSS__Sequence__init(ublox_msgs__msg__CfgGNSS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgGNSS *)calloc(size, sizeof(ublox_msgs__msg__CfgGNSS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgGNSS__Sequence * array = (ublox_msgs__msg__CfgGNSS__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgGNSS__Sequence));
  if (!array) {
    return NULL;
  }
