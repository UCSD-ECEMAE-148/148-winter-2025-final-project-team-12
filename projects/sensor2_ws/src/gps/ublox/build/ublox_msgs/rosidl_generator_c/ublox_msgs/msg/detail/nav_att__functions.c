...
{
  ublox_msgs__msg__NavATT * msg = (ublox_msgs__msg__NavATT *)malloc(sizeof(ublox_msgs__msg__NavATT));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavATT__Sequence__init(ublox_msgs__msg__NavATT__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavATT *)calloc(size, sizeof(ublox_msgs__msg__NavATT));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavATT__Sequence * array = (ublox_msgs__msg__NavATT__Sequence *)malloc(sizeof(ublox_msgs__msg__NavATT__Sequence));
  if (!array) {
    return NULL;
  }
