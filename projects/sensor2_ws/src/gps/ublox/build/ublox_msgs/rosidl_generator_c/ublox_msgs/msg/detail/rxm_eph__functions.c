...
{
  ublox_msgs__msg__RxmEPH * msg = (ublox_msgs__msg__RxmEPH *)malloc(sizeof(ublox_msgs__msg__RxmEPH));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__RxmEPH__Sequence__init(ublox_msgs__msg__RxmEPH__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__RxmEPH *)calloc(size, sizeof(ublox_msgs__msg__RxmEPH));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__RxmEPH__Sequence * array = (ublox_msgs__msg__RxmEPH__Sequence *)malloc(sizeof(ublox_msgs__msg__RxmEPH__Sequence));
  if (!array) {
    return NULL;
  }
