...
{
  ublox_msgs__msg__CfgSBAS * msg = (ublox_msgs__msg__CfgSBAS *)malloc(sizeof(ublox_msgs__msg__CfgSBAS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgSBAS__Sequence__init(ublox_msgs__msg__CfgSBAS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgSBAS *)calloc(size, sizeof(ublox_msgs__msg__CfgSBAS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgSBAS__Sequence * array = (ublox_msgs__msg__CfgSBAS__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgSBAS__Sequence));
  if (!array) {
    return NULL;
  }
