...
{
  ublox_msgs__msg__NavPOSLLH * msg = (ublox_msgs__msg__NavPOSLLH *)malloc(sizeof(ublox_msgs__msg__NavPOSLLH));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavPOSLLH__Sequence__init(ublox_msgs__msg__NavPOSLLH__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavPOSLLH *)calloc(size, sizeof(ublox_msgs__msg__NavPOSLLH));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavPOSLLH__Sequence * array = (ublox_msgs__msg__NavPOSLLH__Sequence *)malloc(sizeof(ublox_msgs__msg__NavPOSLLH__Sequence));
  if (!array) {
    return NULL;
  }
