...
{
  ublox_msgs__msg__NavTIMEUTC * msg = (ublox_msgs__msg__NavTIMEUTC *)malloc(sizeof(ublox_msgs__msg__NavTIMEUTC));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavTIMEUTC__Sequence__init(ublox_msgs__msg__NavTIMEUTC__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavTIMEUTC *)calloc(size, sizeof(ublox_msgs__msg__NavTIMEUTC));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavTIMEUTC__Sequence * array = (ublox_msgs__msg__NavTIMEUTC__Sequence *)malloc(sizeof(ublox_msgs__msg__NavTIMEUTC__Sequence));
  if (!array) {
    return NULL;
  }
