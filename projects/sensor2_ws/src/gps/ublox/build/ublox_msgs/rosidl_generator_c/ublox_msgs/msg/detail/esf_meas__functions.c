...
{
  ublox_msgs__msg__EsfMEAS * msg = (ublox_msgs__msg__EsfMEAS *)malloc(sizeof(ublox_msgs__msg__EsfMEAS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__EsfMEAS__Sequence__init(ublox_msgs__msg__EsfMEAS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__EsfMEAS *)calloc(size, sizeof(ublox_msgs__msg__EsfMEAS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__EsfMEAS__Sequence * array = (ublox_msgs__msg__EsfMEAS__Sequence *)malloc(sizeof(ublox_msgs__msg__EsfMEAS__Sequence));
  if (!array) {
    return NULL;
  }
