...
{
  ublox_msgs__msg__HnrPVT * msg = (ublox_msgs__msg__HnrPVT *)malloc(sizeof(ublox_msgs__msg__HnrPVT));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__HnrPVT__Sequence__init(ublox_msgs__msg__HnrPVT__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__HnrPVT *)calloc(size, sizeof(ublox_msgs__msg__HnrPVT));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__HnrPVT__Sequence * array = (ublox_msgs__msg__HnrPVT__Sequence *)malloc(sizeof(ublox_msgs__msg__HnrPVT__Sequence));
  if (!array) {
    return NULL;
  }
