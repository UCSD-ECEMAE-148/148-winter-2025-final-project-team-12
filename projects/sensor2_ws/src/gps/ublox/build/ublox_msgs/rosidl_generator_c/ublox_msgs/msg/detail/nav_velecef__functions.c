...
{
  ublox_msgs__msg__NavVELECEF * msg = (ublox_msgs__msg__NavVELECEF *)malloc(sizeof(ublox_msgs__msg__NavVELECEF));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavVELECEF__Sequence__init(ublox_msgs__msg__NavVELECEF__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavVELECEF *)calloc(size, sizeof(ublox_msgs__msg__NavVELECEF));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavVELECEF__Sequence * array = (ublox_msgs__msg__NavVELECEF__Sequence *)malloc(sizeof(ublox_msgs__msg__NavVELECEF__Sequence));
  if (!array) {
    return NULL;
  }
