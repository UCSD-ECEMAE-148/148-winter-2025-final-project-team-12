...
{
  ublox_msgs__msg__NavSTATUS * msg = (ublox_msgs__msg__NavSTATUS *)malloc(sizeof(ublox_msgs__msg__NavSTATUS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavSTATUS__Sequence__init(ublox_msgs__msg__NavSTATUS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavSTATUS *)calloc(size, sizeof(ublox_msgs__msg__NavSTATUS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavSTATUS__Sequence * array = (ublox_msgs__msg__NavSTATUS__Sequence *)malloc(sizeof(ublox_msgs__msg__NavSTATUS__Sequence));
  if (!array) {
    return NULL;
  }
