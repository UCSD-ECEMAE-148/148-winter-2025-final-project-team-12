...
{
  ublox_msgs__msg__CfgRST * msg = (ublox_msgs__msg__CfgRST *)malloc(sizeof(ublox_msgs__msg__CfgRST));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgRST__Sequence__init(ublox_msgs__msg__CfgRST__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgRST *)calloc(size, sizeof(ublox_msgs__msg__CfgRST));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgRST__Sequence * array = (ublox_msgs__msg__CfgRST__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgRST__Sequence));
  if (!array) {
    return NULL;
  }
