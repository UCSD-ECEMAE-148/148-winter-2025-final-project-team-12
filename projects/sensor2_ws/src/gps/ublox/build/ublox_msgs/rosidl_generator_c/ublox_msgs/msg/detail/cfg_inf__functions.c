...
{
  ublox_msgs__msg__CfgINF * msg = (ublox_msgs__msg__CfgINF *)malloc(sizeof(ublox_msgs__msg__CfgINF));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgINF__Sequence__init(ublox_msgs__msg__CfgINF__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgINF *)calloc(size, sizeof(ublox_msgs__msg__CfgINF));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgINF__Sequence * array = (ublox_msgs__msg__CfgINF__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgINF__Sequence));
  if (!array) {
    return NULL;
  }
