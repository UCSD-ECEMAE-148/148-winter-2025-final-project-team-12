...
{
  ublox_msgs__msg__CfgANT * msg = (ublox_msgs__msg__CfgANT *)malloc(sizeof(ublox_msgs__msg__CfgANT));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgANT__Sequence__init(ublox_msgs__msg__CfgANT__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgANT *)calloc(size, sizeof(ublox_msgs__msg__CfgANT));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgANT__Sequence * array = (ublox_msgs__msg__CfgANT__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgANT__Sequence));
  if (!array) {
    return NULL;
  }
