...
{
  ublox_msgs__msg__CfgNMEA * msg = (ublox_msgs__msg__CfgNMEA *)malloc(sizeof(ublox_msgs__msg__CfgNMEA));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgNMEA__Sequence__init(ublox_msgs__msg__CfgNMEA__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgNMEA *)calloc(size, sizeof(ublox_msgs__msg__CfgNMEA));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgNMEA__Sequence * array = (ublox_msgs__msg__CfgNMEA__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgNMEA__Sequence));
  if (!array) {
    return NULL;
  }
