...
{
  ublox_msgs__msg__EsfRAWBlock * msg = (ublox_msgs__msg__EsfRAWBlock *)malloc(sizeof(ublox_msgs__msg__EsfRAWBlock));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__EsfRAWBlock__Sequence__init(ublox_msgs__msg__EsfRAWBlock__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__EsfRAWBlock *)calloc(size, sizeof(ublox_msgs__msg__EsfRAWBlock));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__EsfRAWBlock__Sequence * array = (ublox_msgs__msg__EsfRAWBlock__Sequence *)malloc(sizeof(ublox_msgs__msg__EsfRAWBlock__Sequence));
  if (!array) {
    return NULL;
  }
