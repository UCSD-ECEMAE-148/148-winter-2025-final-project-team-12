...
{
  ublox_msgs__msg__CfgDGNSS * msg = (ublox_msgs__msg__CfgDGNSS *)malloc(sizeof(ublox_msgs__msg__CfgDGNSS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgDGNSS__Sequence__init(ublox_msgs__msg__CfgDGNSS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgDGNSS *)calloc(size, sizeof(ublox_msgs__msg__CfgDGNSS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgDGNSS__Sequence * array = (ublox_msgs__msg__CfgDGNSS__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgDGNSS__Sequence));
  if (!array) {
    return NULL;
  }
