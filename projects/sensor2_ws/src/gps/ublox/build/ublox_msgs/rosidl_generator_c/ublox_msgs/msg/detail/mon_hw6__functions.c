...
{
  ublox_msgs__msg__MonHW6 * msg = (ublox_msgs__msg__MonHW6 *)malloc(sizeof(ublox_msgs__msg__MonHW6));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__MonHW6__Sequence__init(ublox_msgs__msg__MonHW6__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__MonHW6 *)calloc(size, sizeof(ublox_msgs__msg__MonHW6));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__MonHW6__Sequence * array = (ublox_msgs__msg__MonHW6__Sequence *)malloc(sizeof(ublox_msgs__msg__MonHW6__Sequence));
  if (!array) {
    return NULL;
  }
