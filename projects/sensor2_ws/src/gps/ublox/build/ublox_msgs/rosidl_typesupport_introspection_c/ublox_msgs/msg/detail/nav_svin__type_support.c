...
void NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_init_function(
...
void NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_fini_function(void * message_memory)
{
  ublox_msgs__msg__NavSVIN__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_member_array[16] = {
  {
    "version",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_members = {
  "ublox_msgs__msg",  // message namespace
  "NavSVIN",  // message name
  16,  // number of fields
  sizeof(ublox_msgs__msg__NavSVIN),
  NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_member_array,  // message members
  NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_init_function,  // function to initialize message memory (memory has to be allocated)
  NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_type_support_handle = {
  0,
  &NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_msgs, msg, NavSVIN)() {
  if (!NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_type_support_handle.typesupport_identifier) {
    NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &NavSVIN__rosidl_typesupport_introspection_c__NavSVIN_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
