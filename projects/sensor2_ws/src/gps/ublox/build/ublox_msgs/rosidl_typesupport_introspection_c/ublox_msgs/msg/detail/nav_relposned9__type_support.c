...
void NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_init_function(
...
void NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_fini_function(void * message_memory)
{
  ublox_msgs__msg__NavRELPOSNED9__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_member_array[21] = {
  {
    "version",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_members = {
  "ublox_msgs__msg",  // message namespace
  "NavRELPOSNED9",  // message name
  21,  // number of fields
  sizeof(ublox_msgs__msg__NavRELPOSNED9),
  NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_member_array,  // message members
  NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_init_function,  // function to initialize message memory (memory has to be allocated)
  NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_type_support_handle = {
  0,
  &NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_msgs, msg, NavRELPOSNED9)() {
  if (!NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_type_support_handle.typesupport_identifier) {
    NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &NavRELPOSNED9__rosidl_typesupport_introspection_c__NavRELPOSNED9_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
