...
struct EsfSTATUS_
{
  ...
  using _sens_type =
    std::vector<ublox_msgs::msg::EsfSTATUSSens_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::EsfSTATUSSens_<ContainerAllocator>>::other>;
  _sens_type sens;
  ...
  Type & set__sens(
    const std::vector<ublox_msgs::msg::EsfSTATUSSens_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::EsfSTATUSSens_<ContainerAllocator>>::other> & _arg)
  {
    this->sens = _arg;
    return *this;
  }
