...
struct NavSVINFO_
{
  ...
  using _sv_type =
    std::vector<ublox_msgs::msg::NavSVINFOSV_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::NavSVINFOSV_<ContainerAllocator>>::other>;
  _sv_type sv;
  ...
  Type & set__sv(
    const std::vector<ublox_msgs::msg::NavSVINFOSV_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::NavSVINFOSV_<ContainerAllocator>>::other> & _arg)
  {
    this->sv = _arg;
    return *this;
  }
