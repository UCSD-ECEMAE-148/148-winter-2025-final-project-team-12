...
{
  ublox_msgs__msg__NavSVIN * msg = (ublox_msgs__msg__NavSVIN *)malloc(sizeof(ublox_msgs__msg__NavSVIN));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavSVIN__Sequence__init(ublox_msgs__msg__NavSVIN__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavSVIN *)calloc(size, sizeof(ublox_msgs__msg__NavSVIN));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavSVIN__Sequence * array = (ublox_msgs__msg__NavSVIN__Sequence *)malloc(sizeof(ublox_msgs__msg__NavSVIN__Sequence));
  if (!array) {
    return NULL;
  }
