...
{
  ublox_msgs__msg__NavSVINFOSV * msg = (ublox_msgs__msg__NavSVINFOSV *)malloc(sizeof(ublox_msgs__msg__NavSVINFOSV));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavSVINFOSV__Sequence__init(ublox_msgs__msg__NavSVINFOSV__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavSVINFOSV *)calloc(size, sizeof(ublox_msgs__msg__NavSVINFOSV));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavSVINFOSV__Sequence * array = (ublox_msgs__msg__NavSVINFOSV__Sequence *)malloc(sizeof(ublox_msgs__msg__NavSVINFOSV__Sequence));
  if (!array) {
    return NULL;
  }
