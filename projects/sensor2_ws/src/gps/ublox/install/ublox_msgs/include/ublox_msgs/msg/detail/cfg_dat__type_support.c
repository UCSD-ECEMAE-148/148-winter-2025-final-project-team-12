...
void CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_init_function(
...
void CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_fini_function(void * message_memory)
{
  ublox_msgs__msg__CfgDAT__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_member_array[11] = {
  {
    "datum_num",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_members = {
  "ublox_msgs__msg",  // message namespace
  "CfgDAT",  // message name
  11,  // number of fields
  sizeof(ublox_msgs__msg__CfgDAT),
  CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_member_array,  // message members
  CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_init_function,  // function to initialize message memory (memory has to be allocated)
  CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_type_support_handle = {
  0,
  &CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_msgs, msg, CfgDAT)() {
  if (!CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_type_support_handle.typesupport_identifier) {
    CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &CfgDAT__rosidl_typesupport_introspection_c__CfgDAT_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
