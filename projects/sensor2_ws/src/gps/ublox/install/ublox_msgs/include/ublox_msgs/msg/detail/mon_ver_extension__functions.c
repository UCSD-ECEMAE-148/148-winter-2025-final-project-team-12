...
{
  ublox_msgs__msg__MonVERExtension * msg = (ublox_msgs__msg__MonVERExtension *)malloc(sizeof(ublox_msgs__msg__MonVERExtension));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__MonVERExtension__Sequence__init(ublox_msgs__msg__MonVERExtension__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__MonVERExtension *)calloc(size, sizeof(ublox_msgs__msg__MonVERExtension));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__MonVERExtension__Sequence * array = (ublox_msgs__msg__MonVERExtension__Sequence *)malloc(sizeof(ublox_msgs__msg__MonVERExtension__Sequence));
  if (!array) {
    return NULL;
  }
