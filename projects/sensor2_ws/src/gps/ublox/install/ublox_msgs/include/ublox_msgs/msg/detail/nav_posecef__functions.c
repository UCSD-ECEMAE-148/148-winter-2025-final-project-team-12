...
{
  ublox_msgs__msg__NavPOSECEF * msg = (ublox_msgs__msg__NavPOSECEF *)malloc(sizeof(ublox_msgs__msg__NavPOSECEF));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavPOSECEF__Sequence__init(ublox_msgs__msg__NavPOSECEF__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavPOSECEF *)calloc(size, sizeof(ublox_msgs__msg__NavPOSECEF));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavPOSECEF__Sequence * array = (ublox_msgs__msg__NavPOSECEF__Sequence *)malloc(sizeof(ublox_msgs__msg__NavPOSECEF__Sequence));
  if (!array) {
    return NULL;
  }
