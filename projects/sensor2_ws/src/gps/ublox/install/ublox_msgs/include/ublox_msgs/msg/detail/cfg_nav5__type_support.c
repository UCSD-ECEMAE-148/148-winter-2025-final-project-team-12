...
void CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_init_function(
...
void CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_fini_function(void * message_memory)
{
  ublox_msgs__msg__CfgNAV5__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_member_array[19] = {
  {
    "mask",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_members = {
  "ublox_msgs__msg",  // message namespace
  "CfgNAV5",  // message name
  19,  // number of fields
  sizeof(ublox_msgs__msg__CfgNAV5),
  CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_member_array,  // message members
  CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_init_function,  // function to initialize message memory (memory has to be allocated)
  CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_type_support_handle = {
  0,
  &CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_msgs, msg, CfgNAV5)() {
  if (!CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_type_support_handle.typesupport_identifier) {
    CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &CfgNAV5__rosidl_typesupport_introspection_c__CfgNAV5_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
