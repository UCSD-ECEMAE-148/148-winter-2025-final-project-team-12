...
{
  ublox_msgs__msg__AidHUI * msg = (ublox_msgs__msg__AidHUI *)malloc(sizeof(ublox_msgs__msg__AidHUI));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__AidHUI__Sequence__init(ublox_msgs__msg__AidHUI__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__AidHUI *)calloc(size, sizeof(ublox_msgs__msg__AidHUI));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__AidHUI__Sequence * array = (ublox_msgs__msg__AidHUI__Sequence *)malloc(sizeof(ublox_msgs__msg__AidHUI__Sequence));
  if (!array) {
    return NULL;
  }
