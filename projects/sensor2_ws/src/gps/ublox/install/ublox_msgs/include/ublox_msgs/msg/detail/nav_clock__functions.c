...
{
  ublox_msgs__msg__NavCLOCK * msg = (ublox_msgs__msg__NavCLOCK *)malloc(sizeof(ublox_msgs__msg__NavCLOCK));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavCLOCK__Sequence__init(ublox_msgs__msg__NavCLOCK__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavCLOCK *)calloc(size, sizeof(ublox_msgs__msg__NavCLOCK));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavCLOCK__Sequence * array = (ublox_msgs__msg__NavCLOCK__Sequence *)malloc(sizeof(ublox_msgs__msg__NavCLOCK__Sequence));
  if (!array) {
    return NULL;
  }
