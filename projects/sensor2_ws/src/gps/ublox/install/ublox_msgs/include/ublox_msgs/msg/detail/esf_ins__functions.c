...
{
  ublox_msgs__msg__EsfINS * msg = (ublox_msgs__msg__EsfINS *)malloc(sizeof(ublox_msgs__msg__EsfINS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__EsfINS__Sequence__init(ublox_msgs__msg__EsfINS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__EsfINS *)calloc(size, sizeof(ublox_msgs__msg__EsfINS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__EsfINS__Sequence * array = (ublox_msgs__msg__EsfINS__Sequence *)malloc(sizeof(ublox_msgs__msg__EsfINS__Sequence));
  if (!array) {
    return NULL;
  }
