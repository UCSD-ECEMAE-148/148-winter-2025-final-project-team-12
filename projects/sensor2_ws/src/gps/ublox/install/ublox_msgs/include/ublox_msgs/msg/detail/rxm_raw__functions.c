...
{
  ublox_msgs__msg__RxmRAW * msg = (ublox_msgs__msg__RxmRAW *)malloc(sizeof(ublox_msgs__msg__RxmRAW));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__RxmRAW__Sequence__init(ublox_msgs__msg__RxmRAW__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__RxmRAW *)calloc(size, sizeof(ublox_msgs__msg__RxmRAW));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__RxmRAW__Sequence * array = (ublox_msgs__msg__RxmRAW__Sequence *)malloc(sizeof(ublox_msgs__msg__RxmRAW__Sequence));
  if (!array) {
    return NULL;
  }
