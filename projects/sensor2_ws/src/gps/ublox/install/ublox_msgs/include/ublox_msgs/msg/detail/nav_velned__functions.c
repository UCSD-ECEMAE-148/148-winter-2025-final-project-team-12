...
{
  ublox_msgs__msg__NavVELNED * msg = (ublox_msgs__msg__NavVELNED *)malloc(sizeof(ublox_msgs__msg__NavVELNED));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavVELNED__Sequence__init(ublox_msgs__msg__NavVELNED__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavVELNED *)calloc(size, sizeof(ublox_msgs__msg__NavVELNED));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavVELNED__Sequence * array = (ublox_msgs__msg__NavVELNED__Sequence *)malloc(sizeof(ublox_msgs__msg__NavVELNED__Sequence));
  if (!array) {
    return NULL;
  }
