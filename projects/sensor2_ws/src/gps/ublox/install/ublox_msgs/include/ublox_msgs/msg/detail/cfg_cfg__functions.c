...
{
  ublox_msgs__msg__CfgCFG * msg = (ublox_msgs__msg__CfgCFG *)malloc(sizeof(ublox_msgs__msg__CfgCFG));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__CfgCFG__Sequence__init(ublox_msgs__msg__CfgCFG__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__CfgCFG *)calloc(size, sizeof(ublox_msgs__msg__CfgCFG));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__CfgCFG__Sequence * array = (ublox_msgs__msg__CfgCFG__Sequence *)malloc(sizeof(ublox_msgs__msg__CfgCFG__Sequence));
  if (!array) {
    return NULL;
  }
