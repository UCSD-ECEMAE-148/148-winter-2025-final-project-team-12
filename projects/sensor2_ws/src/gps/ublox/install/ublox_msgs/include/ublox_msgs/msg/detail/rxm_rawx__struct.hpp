...
struct RxmRAWX_
{
  ...
  using _meas_type =
    std::vector<ublox_msgs::msg::RxmRAWXMeas_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::RxmRAWXMeas_<ContainerAllocator>>::other>;
  _meas_type meas;
  ...
  Type & set__meas(
    const std::vector<ublox_msgs::msg::RxmRAWXMeas_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::RxmRAWXMeas_<ContainerAllocator>>::other> & _arg)
  {
    this->meas = _arg;
    return *this;
  }
