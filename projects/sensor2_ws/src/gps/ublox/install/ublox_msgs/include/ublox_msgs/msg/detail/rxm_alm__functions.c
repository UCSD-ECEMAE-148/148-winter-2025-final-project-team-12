...
{
  ublox_msgs__msg__RxmALM * msg = (ublox_msgs__msg__RxmALM *)malloc(sizeof(ublox_msgs__msg__RxmALM));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__RxmALM__Sequence__init(ublox_msgs__msg__RxmALM__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__RxmALM *)calloc(size, sizeof(ublox_msgs__msg__RxmALM));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__RxmALM__Sequence * array = (ublox_msgs__msg__RxmALM__Sequence *)malloc(sizeof(ublox_msgs__msg__RxmALM__Sequence));
  if (!array) {
    return NULL;
  }
