...
{
  ublox_msgs__msg__NavSATSV * msg = (ublox_msgs__msg__NavSATSV *)malloc(sizeof(ublox_msgs__msg__NavSATSV));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__NavSATSV__Sequence__init(ublox_msgs__msg__NavSATSV__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__NavSATSV *)calloc(size, sizeof(ublox_msgs__msg__NavSATSV));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__NavSATSV__Sequence * array = (ublox_msgs__msg__NavSATSV__Sequence *)malloc(sizeof(ublox_msgs__msg__NavSATSV__Sequence));
  if (!array) {
    return NULL;
  }
