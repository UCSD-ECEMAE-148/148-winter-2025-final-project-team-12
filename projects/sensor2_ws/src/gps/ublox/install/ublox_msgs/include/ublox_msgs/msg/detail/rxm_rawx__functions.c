...
{
  ublox_msgs__msg__RxmRAWX * msg = (ublox_msgs__msg__RxmRAWX *)malloc(sizeof(ublox_msgs__msg__RxmRAWX));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__RxmRAWX__Sequence__init(ublox_msgs__msg__RxmRAWX__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__RxmRAWX *)calloc(size, sizeof(ublox_msgs__msg__RxmRAWX));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__RxmRAWX__Sequence * array = (ublox_msgs__msg__RxmRAWX__Sequence *)malloc(sizeof(ublox_msgs__msg__RxmRAWX__Sequence));
  if (!array) {
    return NULL;
  }
