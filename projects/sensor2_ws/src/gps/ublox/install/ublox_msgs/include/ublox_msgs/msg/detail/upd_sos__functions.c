...
{
  ublox_msgs__msg__UpdSOS * msg = (ublox_msgs__msg__UpdSOS *)malloc(sizeof(ublox_msgs__msg__UpdSOS));
  if (!msg) {
    return NULL;
  }
...
ublox_msgs__msg__UpdSOS__Sequence__init(ublox_msgs__msg__UpdSOS__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ublox_msgs__msg__UpdSOS *)calloc(size, sizeof(ublox_msgs__msg__UpdSOS));
    if (!data) {
      return false;
    }
...
{
  ublox_msgs__msg__UpdSOS__Sequence * array = (ublox_msgs__msg__UpdSOS__Sequence *)malloc(sizeof(ublox_msgs__msg__UpdSOS__Sequence));
  if (!array) {
    return NULL;
  }
