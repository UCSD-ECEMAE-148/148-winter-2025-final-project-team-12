...
struct MonVER_
{
  ...
  using _extension_type =
    std::vector<ublox_msgs::msg::MonVERExtension_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::MonVERExtension_<ContainerAllocator>>::other>;
  ...
  Type & set__extension(
    const std::vector<ublox_msgs::msg::MonVERExtension_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::MonVERExtension_<ContainerAllocator>>::other> & _arg)
  {
    this->extension = _arg;
    return *this;
  }
