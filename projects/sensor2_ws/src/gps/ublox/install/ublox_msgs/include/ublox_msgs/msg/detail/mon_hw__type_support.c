...
void MonHW__rosidl_typesupport_introspection_c__MonHW_init_function(
...
void MonHW__rosidl_typesupport_introspection_c__MonHW_fini_function(void * message_memory)
{
  ublox_msgs__msg__MonHW__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MonHW__rosidl_typesupport_introspection_c__MonHW_message_member_array[17] = {
  {
    "pin_sel",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers MonHW__rosidl_typesupport_introspection_c__MonHW_message_members = {
  "ublox_msgs__msg",  // message namespace
  "MonHW",  // message name
  17,  // number of fields
  sizeof(ublox_msgs__msg__MonHW),
  MonHW__rosidl_typesupport_introspection_c__MonHW_message_member_array,  // message members
  MonHW__rosidl_typesupport_introspection_c__MonHW_init_function,  // function to initialize message memory (memory has to be allocated)
  MonHW__rosidl_typesupport_introspection_c__MonHW_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MonHW__rosidl_typesupport_introspection_c__MonHW_message_type_support_handle = {
  0,
  &MonHW__rosidl_typesupport_introspection_c__MonHW_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_msgs, msg, MonHW)() {
  if (!MonHW__rosidl_typesupport_introspection_c__MonHW_message_type_support_handle.typesupport_identifier) {
    MonHW__rosidl_typesupport_introspection_c__MonHW_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MonHW__rosidl_typesupport_introspection_c__MonHW_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
