...
struct CfgGNSS_
{
  ...
  using _blocks_type =
    std::vector<ublox_msgs::msg::CfgGNSSBlock_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::CfgGNSSBlock_<ContainerAllocator>>::other>;
  _blocks_type blocks;
  ...
  Type & set__blocks(
    const std::vector<ublox_msgs::msg::CfgGNSSBlock_<ContainerAllocator>, typename ContainerAllocator::template rebind<ublox_msgs::msg::CfgGNSSBlock_<ContainerAllocator>>::other> & _arg)
  {
    this->blocks = _arg;
    return *this;
  }
